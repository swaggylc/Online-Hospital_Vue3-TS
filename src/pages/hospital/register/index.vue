...
<template>
  <div class="register">
    <div class="top">
      ...
      <div class="level">
        <svg t="1688519868578" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="content">
      ...
      <div class="right">
        ...
        <div class="rule">
          <p>医院预约规则：</p>
          <span v-for="(item, index) in hospitalStore.hospitalInfo.bookingRule
            ?.rule" :key="item">{{ index + 1 }}：{{ item }}<br /></span>
        </div>
      </div>
    </div>
    <!-- 展示医院详细科室 -->
    <div class="department">
      <div class="leftNav">
        <ul>
          <li v-for="(item, index) in hospitalStore.departmentArr" :key="item.depcode"
      ...
      <div class="rightContent">
        <!-- 右侧 -->
        <div class="showDepartment" v-for="item in hospitalStore.departmentArr" :key="item.depcode">
