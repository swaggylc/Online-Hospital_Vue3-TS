  ...
  <div class="detail">
    ...
    <div class="content">
      ...
      <div class="right">
        ...
        <div class="route">
          <span
            >规划路线：{{ hospitalStore.hospitalInfo.hospital?.route }}</span
          >
        </div>
      </div>
    </div>
    <div class="intro" v-if="hospitalStore.hospitalInfo.hospital?.intro ">
      <p>医院介绍</p>
      <br />
      <span>{{ hospitalStore.hospitalInfo.hospital?.intro }}</span>
    </div>
  </div>
</template>
