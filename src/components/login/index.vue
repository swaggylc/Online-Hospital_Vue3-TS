        ...
        <div class="left">
          <div class="login">
            <div v-show="show == 0">
              ...
              <el-button style="width: 100%" type="primary" :disabled="!isPhone || loginParam.code.length != 6"
                @click="login">登录</el-button>
              <div class="bottom" @click="changeShow">
                <p>使用扫一扫登陆</p>
                <svg t="1688560350055" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="2362" width="32" height="32">
                  <path
        ...
        <div class="right">
          <div class="top">
            <div class="top_left">
              ...
              <svg t="1688561696933" class="icon" viewBox="0 0 1025 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="5381" width="16" height="16">
                <path
            ...
            <div class="top_right">
              ...
              <svg t="1688561657319" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
